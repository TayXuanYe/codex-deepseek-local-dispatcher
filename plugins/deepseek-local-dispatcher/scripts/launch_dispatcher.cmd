...
if "%~1"=="" (
  echo DeepSeek local dispatcher could not start: missing MCP server path. 1>&2
  exit /b 64
)
...
echo DeepSeek local dispatcher could not find a Node runtime. Reinstall or update Codex. 1>&2
exit /b 127
